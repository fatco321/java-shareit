...
public class ItemRequestController {
    ...
    public ResponseEntity<Object> createItemRequest(@RequestBody @Valid ItemRequestDto itemRequestDto,
                                                    @NotNull @RequestHeader(header) Long userId) {
    ...
    @GetMapping
    public ResponseEntity<Object> getByOwnerId(@RequestHeader(header) @NotNull Long userId) {
    ...
    @GetMapping("/all")
    public ResponseEntity<Object> getAll(@NotNull @RequestHeader(header) Long userId,
